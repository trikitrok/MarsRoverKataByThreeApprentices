...
public class WhenFacingSouth {
    ...
    public void left() {
        ...
        assertTrue(rover.at(new Location(position, Orientation.EAST, world)));
    }
    ...
    public void right() {
        ...
        assertTrue(rover.at(new Location(position, Orientation.WEST, world)));
    }
    ...
    public void setUp() {
        ...
        rover = new Rover(new Location(position, Orientation.SOUTH, world), signalsToCommands);
    }
}
